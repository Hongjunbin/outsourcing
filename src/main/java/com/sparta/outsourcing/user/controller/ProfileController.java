...
public class ProfileController {
    ...
    @GetMapping("/profile")
    public ResponseEntity<CommonResponse<UserLikeResponseDto>> getUser(@AuthenticationPrincipal UserDetailsImpl userDetails) {
        CommonResponse<UserLikeResponseDto> response = new CommonResponse<>("성공", 200, userService.getUser(userDetails.getUser()));
